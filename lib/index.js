...
try {
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
      apply, CFG, DEFAULTS,
      compileRules, guardStream, findBlockedChar, detectScript,
      scanDelta, countMixedScripts, evaluateBlock, replaceHits,
      hardBlockFinish, emitAudit, recordInterrupt, payloadSlice, isoTime,
      summarize, bounded, sampleOf, escapeRegex,
    }
  }
} catch (e) { /* 动态插件沙箱无 module：忽略 */ }
